...
#  NOT NULL, UNIQUE
#  바뀔 가능성이 현저히 낮아야함
#  가장 좋은 PK 는 의미없는 컬럼이다. (마리아db가 자동증가하는)
...
(
    id           INT PRIMARY KEY AUTO_INCREMENT,
    customer_id  INT,# primary key값을 가져옴
...
INSERT INTO phone_number
    (customer_id, phone_number)
VALUES (3, '7890'); # 3번 고객이 없어서 불가능
SELECT *
FROM phone_number;
#customer와 phone_number는 1:N 또는 1대 다 관계
