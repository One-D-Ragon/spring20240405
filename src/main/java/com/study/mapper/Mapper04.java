...
public interface Mapper04 {
    ...
    @Select("""
            ...
            SELECT string_col stringCol,
                    int_col intCol,
                    /*int_col을 intCol으로 별칭을 주지 않아도 mybatis는 spring에서 lowerCamelCase를 사용하는 것을 안다*/
                    dec_col decCol,
                    date_col dateCol,
    ...
    @Insert("""
            ...
            VALUES 
                (#{a1}, #{a2}, #{a3}, #{a4}, #{a5}, #{a6})
            """)
    int insert3(String a1, String a2, Integer a3, Double a4, LocalDate a5, LocalDateTime a6);
