...
//        model.addAttribute("age", 3); // 어린이용 콘텐츠
        model.addAttribute("age", 13); // 청소년 콘텐츠
...
//         model.addAttribute("age", 33); // 성인용 콘텐츠
    ...
    public void method4(Model model) {
        ...
        model.addAttribute("myList2", List.of("BAR", "PSG", "ATM", "BVB"));
        model.addAttribute("myMap2", Map.of("BAR vs PSG", "바르셀로나 승",
                "ATM vs BVB", "아틀레티코 마드리드 승"));
    }
    ...
    public void method6(Model model) {
        ...
        MyBean121 e4 = new MyBean121("x6", "bmw", "독일", 7000);
