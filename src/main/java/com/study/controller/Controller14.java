...
public class Controller14 {
    ...
    @RequestMapping("sub4")
    public String sub4(@ModelAttribute MyBean142 o1) { //modelattribute에 이름을 안적음
        o1.setName("김민재");

        return "/main14/sub3"; // view로 포워드(3번째 jsp로 포워딩)
    }
    ...
    // todo : city, country, price 프로퍼리가 있는 클래스 만들고
    // 그 클래스를 사용해서
