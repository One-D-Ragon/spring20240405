...
public class Controller22 {
    ...
    public String sub1() {
        // view forward
        return "/main22/sub1"; // 요청 경로와 view 이름이 같으면 생략 가능
    }
    ...
    public String method7(String id, String password) {
        ...
        //  실패이면 login form으로 이동하라는 redirect 응답
    ...
    public String method9(RedirectAttributes rttr) {
        ...
        // redirection 시 정보전달은 RedirectAttributes 활용 (rttr = redirectAttributes)
        ...
        // query string
//        return "redirect:/main22/sub10?condition=ok";
...
//    }
    ...
    public String method17(String id, String pw, RedirectAttributes rttr) {
        boolean ok = id.equals(pw);
        if (ok) {
            rttr.addFlashAttribute("con", "ok");

            return "redirect:/main22/sub18";
        } else {
            rttr.addFlashAttribute("con", "no");
